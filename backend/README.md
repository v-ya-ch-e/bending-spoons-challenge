...
project documentation generation/chat, and matching. It should call
...
`DB_API_BASE_URL` must point at the db-rest-api service for matching runs and
generated project documentation persistence.
